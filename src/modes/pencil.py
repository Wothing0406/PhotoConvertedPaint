...
def _generate_color_cross_contour_hatching(img_rgb, gray, saliency_norm, w, h, hatching_intensity, fc, R, shading_flow_angle=45.0, bg_hatching_angle=135.0):
    strokes = []
...
def draw(
    ...
    **kw,
    ...
    all_hatching = _generate_color_cross_contour_hatching(img_np, gray, saliency_norm, w, h, hatching, fc, R, shading_angle, bg_angle)
